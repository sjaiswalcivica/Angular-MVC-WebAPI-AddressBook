...
var StateComponent = /** @class */ (function () {
    ...
    StateComponent.prototype.GetAllStates = function () {
        var _this = this;
        this.service.GetAll().subscribe(function (states) { return _this.states = states; }, function (error) { return _this.errorMessage = error; });
    };
    StateComponent.prototype.GetAllCountries = function () {
        var _this = this;
        this.countryService.GetAll().subscribe(function (countries) { return _this.countries = countries; }, function (error) { return _this.errorMessage = error; });
    };
    StateComponent.prototype.GetState = function (id) {
        var _this = this;
        if (id !== undefined)
            this.service.Get(id).subscribe(function (state) { return _this.state = state; }, function (error) { return _this.errorMessage = error; });
    };
    StateComponent.prototype.AddState = function () {
        var _this = this;
        this.service.Add(this.state).subscribe(function (states) { return _this.states = states; }, function (error) { return _this.errorMessage = error; });
    };
    StateComponent.prototype.EditState = function () {
        var _this = this;
        console.log(this.state);
        this.service.Edit(this.state).subscribe(function (states) { return _this.states = states; }, function (error) { return _this.errorMessage = error; });
    };
    StateComponent.prototype.DeleteState = function (stateId) {
        var _this = this;
        this.service.Delete(stateId).subscribe(function (states) { return _this.states = states; }, function (error) { return _this.errorMessage = error; });
    };
