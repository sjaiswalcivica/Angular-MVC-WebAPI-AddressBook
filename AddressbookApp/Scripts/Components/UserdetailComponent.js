...
var UserdetailComponent = (function () {
    ...
    UserdetailComponent.prototype.GetUser = function (id) {
        var _this = this;
        if (id !== undefined)
            this.service.Get(id).subscribe(function (user) { return _this.user = user; });
    };
    UserdetailComponent.prototype.AddUser = function () {
        var _this = this;
        this.service.Add(this.user).subscribe(function (users) { return _this.users = users; });
    };
    UserdetailComponent.prototype.EditUser = function () {
        var _this = this;
        this.service.Edit(this.user).subscribe(function (users) { return _this.users = users; });
    };
    UserdetailComponent.prototype.DeleteUser = function (userId) {
        var _this = this;
        this.service.Delete(userId).subscribe(function (users) { return _this.users = users; });
    };
