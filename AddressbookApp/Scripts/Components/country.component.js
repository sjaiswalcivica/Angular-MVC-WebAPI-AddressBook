...
var CountryComponent = /** @class */ (function () {
    ...
    CountryComponent.prototype.GetAllCountries = function () {
        var _this = this;
        this.service.GetAll().subscribe(function (countries) { return _this.countries = countries; }, function (error) { return _this.errorMessage = error; });
    };
    CountryComponent.prototype.GetCountry = function (id) {
        var _this = this;
        if (id !== undefined)
            this.service.Get(id).subscribe(function (country) { return _this.country = country; }, function (error) { return _this.errorMessage = error; });
    };
    CountryComponent.prototype.AddCountry = function () {
        var _this = this;
        this.service.Add(this.country).subscribe(function (countries) { return _this.countries = countries; }, function (error) { return _this.errorMessage = error; });
    };
    CountryComponent.prototype.EditCountry = function () {
        var _this = this;
        this.service.Edit(this.country).subscribe(function (countries) { return _this.countries = countries; }, function (error) { return _this.errorMessage = error; });
    };
    CountryComponent.prototype.DeleteCountry = function (countryId) {
        var _this = this;
        this.service.Delete(countryId).subscribe(function (countries) { return _this.countries = countries; }, function (error) { return _this.errorMessage = error; });
    };
