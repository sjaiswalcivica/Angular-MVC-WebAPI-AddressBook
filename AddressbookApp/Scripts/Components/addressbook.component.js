...
var AddressbookComponent = /** @class */ (function () {
    ...
    AddressbookComponent.prototype.GetAllStates = function () {
        var _this = this;
        this.stateService.GetAll().subscribe(function (states) { return _this.states = states; }, function (error) { return _this.errorMessage = error; });
    };
    AddressbookComponent.prototype.GetAddress = function (id) {
        var _this = this;
        if (id !== undefined)
            this.service.Get(id).subscribe(function (address) { return _this.address = address; }, function (error) { return _this.errorMessage = error; });
    };
    AddressbookComponent.prototype.AddAddress = function () {
        var _this = this;
        this.service.Add(this.address).subscribe(function (addresses) { _this.addresses = addresses; _this.GetFilteredAddresses(); }, function (error) { return _this.errorMessage = error; });
    };
    AddressbookComponent.prototype.EditAddress = function () {
        var _this = this;
        this.service.Edit(this.address).subscribe(function (addresses) { _this.addresses = addresses; _this.GetFilteredAddresses(); }, function (error) { return _this.errorMessage = error; });
    };
    AddressbookComponent.prototype.DeleteAddress = function (addressId) {
        var _this = this;
        this.service.Delete(addressId).subscribe(function (addresses) { _this.addresses = addresses; _this.GetFilteredAddresses(); }, function (error) { return _this.errorMessage = error; });
    };
